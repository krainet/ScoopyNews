...
// Make changes to RADLocation.m instead.

#import "_RADLocation.h"

const struct RADLocationAttributes RADLocationAttributes = {
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct RADLocationRelationships RADLocationRelationships = {
	.news = @"news",
};

@implementation RADLocationID
@end

@implementation _RADLocation
...
- (RADLocationID*)objectID {
	return (RADLocationID*)[super objectID];
}
